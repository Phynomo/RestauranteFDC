                        ...
                        <Modal.Body>
                            ...
                            <div className='col-6'>
                                <div className="ms-form-group has-icon">
                                    ...
                                    <div className="input-group">
                                        <input type="text" className="form-control" id="validationCustom13" placeholder="Municipio" name="muni_Id" value={this.state.muni_Id} onChange={this.handleInputChange} required />
