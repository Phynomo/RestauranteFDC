...
function Content() {
    ...
    const [selectedClientLabel, setSelectedClientLabel] = useState('Consumidor Final');
    const [platillos, setPlatillos] = useState([]);
    const [selectedPlatillo, setSelectedPlatillo] = useState('0');
    const [facturaId, setFacturaId] = useState(0);
    const [metodopago, setMetodopago] = useState([]);
    const [selectmetodopago, setSelectMetodopago] = useState('2');
    ...
    const [disableDetalles, setDisableDetalles] = useState(true);
                ...
                <div className='row'>
                    ...
                    <div className='col-4'>
                        <div className='card' style={{ height: "560px" }}>
                            <div className='card-header' style={{ background: "#ff443c", color: 'white'}}>
