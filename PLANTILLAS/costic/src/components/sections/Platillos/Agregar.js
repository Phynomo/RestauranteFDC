                      ...
                      <div className="ms-panel-footer d-flex">
                        {showGuardarButton && (
                          <div className='row text-center'>
                            <div className='col' style={{ padding: "0px 75%" }}>
                              <button className="btn btn-primary btn-pill d-block mr-3" type="submit">
                                Guardar
                              </button>
                            </div>
                          </div>
                        ...
                        {showEditButton && (
                          <div className='row text-center'>
                            <div className='col' style={{ padding: "0px 85%" }}>
                              <button className="btn btn-primary btn-pill d-block ml-auto" type="button" onClick={handleEdit} >
                                Editar
                              </button>
                            </div>
                          </div>
